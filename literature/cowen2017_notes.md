...
> **결론**: 차원이 "원본"이 아니었다.
> Self-report의 semantic space에서, 감정 **개념(concepts)**은 차원보다 카테고리로 더 세밀하게 분화되어 있다.
...
> **"감정 self-report는 카테고리적 구조를 보이지만, 카테고리들 사이의 경계는 칼로 자른 듯 명확하지 않고 연속적으로 이어져 있다"**
...
### 9.1 이 연구가 말해주는 것 vs 말해주지 않는 것

| 질문 | 이 연구로 답할 수 있는가? |
|:----|:----------------------|
| 사람들이 감정을 **보고할 때** 카테고리가 더 유용한가? | ✓ Yes |
| 감정이 **뇌에서** 카테고리적으로 표상되는가? | ❌ (self-report ≠ 뇌) |
| 감정 **경험 자체**가 카테고리적인가? | ❌ (보고 ≠ 경험) |
| 언어가 없으면 감정 구분이 사라지는가? | ❌ (영어만 연구) |

### 9.2 논문이 명시적으로 인정하는 한계

> "self-report is **not a direct readout of experience**" (p. E7901)

> "reported emotional experience may reflect a combination of:
> (i) emotional experience itself;
> (ii) cognitive and perceptual experiences that may not be emotional; or
> (iii) perception of affective quality" (p. E7907)

### 9.3 함의 정리

| 수준 | 함의 |
|:----|:----|
| **방법론적** | 감정 연구에서 valence-arousal만 측정하면 정보 손실 발생 |
| **개념적** | 감정 어휘가 2차원으로 환원 불가능한 의미 구조를 가짐 |
| **이론적** | Dimensional theory의 "차원이 기본"이라는 주장에 도전 |

### 9.4 Horikawa et al. (2020)과의 연결

Cowen 2017의 한계를 보완하기 위해 Horikawa 2020은 **뇌 활동 수준**에서 동일한 질문을 검증:
...
같은 패턴이 뇌 활동에서도 나타난다면, self-report의 발견이 단순히 "언어적 습관"이 아니라 **신경 표상 수준에서도 유효**하다는 더 강한 주장이 가능해진다.
